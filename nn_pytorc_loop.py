...
#Shuffel the columns
data = data.sample(axis = 1, frac =1)
    ...
    for num_epoch in epochs:
        for learning_rate in learning_rates:
            for batch_size in batch_sizes:
                ...
                # Comprovation if the output has de correct form
                ...
                #Initialize variables for the loss plot
                # loss history
                y_loss = []
                y_err = []
                x_epoch = []
                ...
                #Check acurecy on ytraining and test to see if the model is good
